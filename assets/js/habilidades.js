...
const sobreSkill = [
                    '<p>HTML</p> <br> <p>É a linguagem de marcação utilizada na construção de páginas na Web.</p> <br>',
                    '<p>CSS</p> <br> <p>É uma linguagem de estilo para estilizar um documento web.</p> <br>',
                    ...
                    '<p>Java</p> <br> <p>Java é uma linguagem de programação orientada a objetos desenvolvida na década de 90 e é o padrão global para desenvolvimento e fornecimento de aplicativos mobile e softwares corporativo.</p> <br>',
